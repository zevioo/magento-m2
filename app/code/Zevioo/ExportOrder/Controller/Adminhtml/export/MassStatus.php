...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('export');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Zevioo\ExportOrder\Model\Export')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('exportorder/*/index');
    }
